...
const EventList = () => {
    ...
    const fetchEvents = useCallback(async () => {
        try {
            ...
            // FIX: Use the full API URL for the request
        ...
        <div className="event-list-page">
            ...
            <div className="events-content">
                <div className="events-header">
                    <h3>
                        {filters.category === 'all' ? 'All Events' : categories.find(c => c.value === filters.category)?.label}
...
const CalendarView = ({ events }) => {
    ...
    return (
        <div className="calendar-view" style={{ backgroundImage: 'url(/assets/calender-flower.png)' }}>
